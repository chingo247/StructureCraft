 ...
 */
package com.chingo247.structurecraft.io.util;

import com.chingo247.structurecraft.io.xml.PlacementXMLConstants;
import com.chingo247.structurecraft.io.xml.StructurePlanXMLConstants;
import com.chingo247.structurecraft.io.xml.LineElement;
...
public class PlacementElement extends LineElement {
    ...
    public PlacementElement(File file, LocatedElement element) {
        super(file, element);
    }
    ...
    public String getPlacementReferenceId() {
        ...
        LineElement simpleElement = new LineElement(getFile(), (LocatedElement) n);
    ...
    public int getAxisOffset() {
        ...
        if (dirNode != null) {
            LineElement dirElement = new LineElement(getFile(), (LocatedElement) dirNode);
    ...
    public Vector getPosition() {
        ...
        if (posNode != null) {
            PositionElement posElement = new PositionElement(getFile(), (LocatedElement) posNode);
    ...
    public String getSchematic() {
        ...
        LineElement simpleElement = new LineElement(getFile(), (LocatedElement) schematicNode);
        simpleElement.checkNotEmpty();
        return simpleElement.getTextValue().trim();
    }
