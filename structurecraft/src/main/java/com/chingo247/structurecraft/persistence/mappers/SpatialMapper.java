...
import com.chingo247.structurecraft.util.Tuple2Val;
...
public class SpatialMapper implements ResultSetMapper<Spatial>{
    ...
    public Spatial map(int index, ResultSet r, StatementContext ctx) throws SQLException {
        ...
        Spatial sp = new Spatial(id, min.getBlockX(), max.getBlockX(), min_y, max_y, min.getBlockZ(), max.getBlockZ(), worldUUID, worldName, orientation);
