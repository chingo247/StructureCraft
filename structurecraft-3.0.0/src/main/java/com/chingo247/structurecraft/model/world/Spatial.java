...
public class Spatial {
    ...
    public Spatial(Long id, UUID world, String worldName, CuboidRegion region, Direction direction, String type) {
        this.id = id;
        ...
        this.maxY = max.getBlockZ();
        this.maxZ = max.getBlockZ();
        this.type = type;
    }

    public Spatial(UUID world, String worldName, CuboidRegion region, Direction direction, String type) {
        this(null, world, worldName, region, direction, type);
    }

    public Spatial(Long id, int minX, int maxX, int minY, int maxY, int minZ, int maxZ, UUID worldUUID, String world,  int orientation, String type) {
        this.id = id;
    ...
    public CuboidRegion getCuboid() {
        return new CuboidRegion(getMin(), getMax());
    }
