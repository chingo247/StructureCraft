...
public interface SpatialDAOMySQL57 extends SpatialDAO {
    ...
    @GetGeneratedKeys
    @SqlUpdate("INSERT INTO SPATIALS (origin_x, origin_y, origin_z, orientation, min_y,max_y, envelope, spatial_type, world_uuid, world_name) "
             + "VALUES (:origin_x, :origin_y, :origin_z, :orientation, :min_y, :max_y, (ST_MakeEnvelope(point(:min_x, :min_z), point(:max_x, :max_z))), :spatial_type, :worlduuid, :worldname)")
    @Override
