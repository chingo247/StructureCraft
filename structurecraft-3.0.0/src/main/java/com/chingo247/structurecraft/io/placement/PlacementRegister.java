...
import com.chingo247.structurecraft.exception.placement.PlacementRegisterException;
...
public class PlacementRegister {
    ...
    public static final PlacementRegister IMP = new PlacementRegister();
    ...
    public <T extends IPlacement> void register(Class<T> placmentType) throws PlacementRegisterException {
        ...
        serializers.put(placmentType, xmlSerializer);
        ...
        deserializers.put(placmentType, xmlDeserializer);
    ...
    public boolean isRegistered(Class<? extends IPlacement> placementType) {
        if (!serializers.containsKey(placementType)) {
            return false;
        }
        return deserializers.containsKey(placementType);
    }
