...
import com.chingo247.structurecraft.events.plans.StructurePlansLoadedEvent;
import com.chingo247.structurecraft.events.plans.StructurePlansReloadEvent;
...
public class StructureCraft {
    ...
    private StructureCraft() {
        ...
        asyncEventBus.register(CUISelectionManager.getInstance());
