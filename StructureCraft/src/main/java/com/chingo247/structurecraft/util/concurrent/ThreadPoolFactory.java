...
public class ThreadPoolFactory {
     ...
     */
    public static ExecutorService newCachedThreadPool(int coreSize, int maxSize, long timeOut, TimeUnit unit) {
    ...
    public static ExecutorService newCachedThreadPool(int coreSize, int maxSize) {
