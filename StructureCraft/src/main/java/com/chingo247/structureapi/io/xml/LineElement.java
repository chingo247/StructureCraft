 ...
 */
package com.chingo247.structureapi.io.xml;
...
public class LineElement {
    ...
    public LineElement(File file, LocatedElement element) {
    ...
    public LocatedElement getElement() {
        return (LocatedElement) le.createCopy();
    }
    ...
    public LineElement selectSingleElement(String xpath) {
        ...
        if (e != null) {
            return new LineElement(file, (LocatedElement) e);
        }
        return null;
    }
