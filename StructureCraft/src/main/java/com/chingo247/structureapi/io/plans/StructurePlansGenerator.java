...
import com.chingo247.structureapi.model.placement.SchematicPlacement;
import java.io.File;
 ...
 * @author Chingo
 */
public class StructurePlansGenerator {
    ...
    public static void generate(File directory) {
        ...
        while(fileIterator.hasNext()) {
            ...
            try {
                ...
                Logger.getLogger(StructurePlansGenerator.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    private static void generatePlanFromSchematic(File file, File rootDirectory) throws IOException {
        ...
        typeElement.setText(SchematicPlacement.TYPE);
