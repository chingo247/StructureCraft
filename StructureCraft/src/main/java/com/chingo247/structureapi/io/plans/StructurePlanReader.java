...
import com.chingo247.structureapi.io.xml.ElementValueException;
...
import com.chingo247.structureapi.io.util.PlacementElement;
import com.chingo247.structureapi.io.xml.StructurePlanDocument;
    ...
    private class PlacementProcessor extends RecursiveTask<PlacementSource> {
        ...
        protected PlacementSource compute() {
            try {
                ...
                PlacementRegister.instance().deserialize(element);
