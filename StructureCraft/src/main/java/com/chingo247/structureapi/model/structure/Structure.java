...
public class Structure extends Plot  {
    ...
    private StructureCraft structureCraft;

    public Structure(StructureCraft structureCraft, Node structureNode) {
        this(structureCraft, new StructureNode(structureNode));
    }
    
    public Structure(StructureCraft structureCraft, StructureNode structure) {
        ...
        this.structureCraft = structureCraft;
    }
    ...
    public File getDirectory() {
        return structureCraft.getDirectory(this);
    }
