...
import com.chingo247.structureapi.io.annotations.Resource;
...
import com.chingo247.structureapi.io.schematic.ISchematic;
...
public class SchematicPlacement extends CuboidPlacement {
    ...
    public static SchematicPlacement deserialize(XMLElement element) throws StructurePlanException, IOException {
        ...
        ISchematic schematic = SchematicStorage.IMP.getOrLoad(schematicFile);
