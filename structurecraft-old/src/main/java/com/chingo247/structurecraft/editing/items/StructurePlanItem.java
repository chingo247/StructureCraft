...
public class StructurePlanItem implements CategoryTradeItem {
    ...
    public IItemStack getItemStack() {
        IItemStack item = platform.createItemStack(ItemID.PAPER);
        item.setName(name);
    ...
    public static String getValue(IItemStack item, String key) {
    ...
    public static String getPlanID(IItemStack itemStack) {
        return getValue(itemStack, "UniqueId");
    }

    public static double getPrice(IItemStack itemStack) {
        double price = 0;
    ...
    public static boolean isStructurePlan(IItemStack itemStack) {
        if (itemStack == null) {
            return false;
        }
