...
public class CategoryMenu extends ACategoryMenu {
    ...
    public CategoryMenu(String title, IInventory notThePlayersInventory, String defaultCategory, int defaultCategoryIcon, MenuView view, Map<String, List<CategoryTradeItem>> items) {
        super(title, notThePlayersInventory, defaultCategory, defaultCategoryIcon, view);
        this.items = items;
    }
    
    public CategoryMenu(String title, IInventory notThePlayersInventory, String defaultCategory, int defaultCategoryIcon, MenuView view) {
        this(title, notThePlayersInventory, defaultCategory, defaultCategoryIcon, view, new HashMap<String, List<CategoryTradeItem>>());
    }
