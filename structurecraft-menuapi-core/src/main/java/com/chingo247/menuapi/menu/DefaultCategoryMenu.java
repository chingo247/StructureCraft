...
public class DefaultCategoryMenu extends CategoryMenu {
    ...
    public DefaultCategoryMenu(String title, MenuView menuView) {
        this(title, menuView, new HashMap<String, List<CategoryTradeItem>>());
    }

    public DefaultCategoryMenu(String title, MenuView menuView, Map<String, List<CategoryTradeItem>> items) {
        super(
                title,
