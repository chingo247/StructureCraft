 ...
 */
package com.chingo247.structurecraft.xplatform.core.server;

import com.chingo247.structurecraft.xplatform.core.item.AItemstack;
...
public abstract class APlatform {
    ...
    public abstract IItemStack createItemStack(int material);
    ...
    public abstract IInventory createInventory(String title, int slots);
